...
pygame.display.set_caption('fuddi runner')
...
pygame.mixer.music.load(resource_path('audio/music1.mp3'))
pygame.mixer.music.set_volume(0.4)
pygame.mixer.music.play(-1)
#snail_x_pos=snail_rect.left
score=0
...
while True:
    for event in pygame.event.get():
        ...
        #         print('collision')
    if game_active:
        screen.blit(sky_surface,(0,0)) #block image transfer , putting one surface on another surface
        screen.blit(ground_surface,(0,300))#order matters
        
        # pygame.draw.rect(screen,'#c0e8ec',score_rect)
        # pygame.draw.line(screen,'Gold',(0,0),(800,0),10)
        # screen.blit(score_surf,score_rect)
        ...
        if(score==0):
             ...
             screen.blit(game_message,game_message.get_rect(center=(400,350)))
    pygame.display.update()
    clock.tick(60) #maxframe rate
